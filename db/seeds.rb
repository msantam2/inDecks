...
Card.create!(question: 'Is sodium hydroxide (NaOH) an acid or base?', answer: 'base', mastered: true)
...
Card.create!(question: 'Who led the Manhatten Project?', answer: 'Robert Oppenheimer', mastered: true)
